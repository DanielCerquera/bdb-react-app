...
const ProductForm = ({ onSubmit }) => {
    ...
    return (
        <div className="product-form">
            <Input type="text" name="name" placeholder="Nombre producto 6" value={product.name} onChange={handleChange} />
            <Input type="text" name="description" placeholder="Descripción 6" value={product.description} onChange={handleChange} />
